...
import 'package:axolon_test/view/add_header_view.dart';
import 'package:axolon_test/view/common_widgets/common_app_bar.dart';
import 'package:axolon_test/view/common_widgets/common_widgets_and_helpers.dart';
import 'package:axolon_test/view/details_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../model/header_model.dart';
import 'edit_header_view.dart';
...
class _HeaderScreen extends State<HeaderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
          appBar:CommonAppBar(title: 'Header',onTap: (){},) ,
